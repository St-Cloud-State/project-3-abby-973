...
class View extends JFrame {
  ...
  public View() {
    ...
    PolygonButton polygonButton = new PolygonButton(undoManager, this, drawingPanel);
    TriangleButton triangleButton = new TriangleButton(undoManager, this, drawingPanel);
